...
def parse_args():
    ...
    parser.add_argument("--total-timesteps", type=int, default=2000000)  # small for testing
...
for seed_ in seeds:
    ...
    loss_df.to_csv('TMP2O_20_Pong.csv')

    envs.close()
    writer.close()


    def record_video(env_id, agent, run_name, num_frames=5000, noise_sigma = 0.5):
        ...
        for _ in range(num_frames):
            ...
            with torch.no_grad():
                ...
                obs_tensor = obs_tensor + torch.tensor(noise)
